...
if __name__ == "__main__":
    ...
    if overall_sentiment > 0:
        ...
        print("What a fun to talk to you, your day went well as expected :) (positive)")
        print("Here are some happy song suggestions😊:")
        music_suggestions = get_music_suggestions(1)
    elif overall_sentiment < 0:
        print("Seems you are sad. (negative)"  )
        print("Here are some suggestions for you🫂:")
        music_suggestions = get_music_suggestions(-1)
    else:
        print("Your day went well!  (neutral)")
...
if __name__ == "__main__":
    ...
    for suggestion in music_suggestions:
>>>>>>> a280f4829d7dec1f48c3176c5e3ebfdc9ae4207c
        print(suggestion)